...
extern void initTaxi(Taxi* taxi,Grid* MAPPA, void (*signal_handler)(int), void (*die)(int), int semSetKey, int semMutexKey);
...
extern void taxiDie(Taxi t, int fdWrite, Grid grid, int sem_id, int semMutexKey);
